  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f8fafc', paddingBottom: '2rem' }}>
      ...
      <div id="cotizacion-pdf" className="contenedor-principal" style={{ maxWidth: '1000px', margin: '0 auto', backgroundColor: 'white', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
        ...
        {/* Tabla ORIGINAL con arreglo de visibilidad */}
      ...
      {/* Historial ORIGINAL - SE OCULTA TOTALMENTE EN IMPRESIÓN */}
      <div className="screen-only historial-no-imprimir" style={{ maxWidth: '1000px', margin: '2rem auto', padding: '1.5rem', backgroundColor: 'white' }}>
      ...
      <style dangerouslySetInnerHTML={{__html: `
        @media print {
          ...
          .screen-only, .historial-no-imprimir { display: none !important; visibility: hidden !important; height: 0 !important; overflow: hidden !important; margin: 0 !important; padding: 0 !important; }
